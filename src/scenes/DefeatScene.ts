...
export class DefeatScene extends SceneBase {
    private WIDTH = SceneManager.WIDTH;
    private HEIGHT = SceneManager.HEIGHT;
    private world: Container;
    private defeatMenuBackground: TilingSprite;
    ...
    constructor() {
        ...
        //Background
        this.defeatMenuBackground = new TilingSprite(
            Texture.from('UI/background/Window.png'),
            this.WIDTH,
            this.HEIGHT
        );
        this.defeatMenuBackground.position = this.world.position;

        //START GAME BUTTON
        this.restartGameSection = new Container();
        this.restartGameSection.x = this.defeatMenuBackground.width/4;
        this.restartGameSection.y = this.defeatMenuBackground.height/4;
        ...
        const defeatText = new Text("You lost!", textStyle);
        ...
        this.world.addChild(this.defeatMenuBackground, this.restartGameSection);
